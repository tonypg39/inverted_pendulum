...
class RL_TabAgent(Agent):
    ...
    def getParameters(self):
        return [self.params['learn_rate'],self.params['gamma'],self.params['epsilon']],['learn_rate','gamma','epsilon']
    
    def updateParameters(self,params):
        self.params['learn_rate'] = params[0]
        self.params['ganma'] = params[1]
        self.params['epsilum'] = params[2]
    ...
    def map_force(self, action):
        return self.actions[action]*self.env_params['max_force']
